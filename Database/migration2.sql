...
-- This function will be used by triggers to automatically update the 'updated_at' timestamp.
...
-- This trigger uses the function created above to update the timestamp on every change.
